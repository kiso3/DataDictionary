...
public class Date_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_dwy1sf_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createComponent_dwy1sf_a0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_dwy1sf_b0(editorContext, node));
    return editorCell;
  }
  private EditorCell createComponent_dwy1sf_a0(EditorContext editorContext, SNode node) {
    EditorCell editorCell = editorContext.getCellFactory().createEditorComponentCell(node, "jetbrains.mps.lang.core.editor.alias");
    return editorCell;
  }
  private EditorCell createProperty_dwy1sf_b0(EditorContext editorContext, SNode node) {
