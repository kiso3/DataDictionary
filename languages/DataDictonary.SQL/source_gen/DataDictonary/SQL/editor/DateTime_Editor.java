...
public class DateTime_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_tsrqko_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_tsrqko_b0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createProperty_tsrqko_b0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
    provider.setRole("DateTimeFormat");
    provider.setNoTargetText("<no DateTimeFormat>");
    EditorCell editorCell;
    editorCell = provider.createEditorCell(editorContext);
    editorCell.setCellId("property_DateTimeFormat");
