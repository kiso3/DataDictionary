...
public class check_StructureAsAField_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode structureAsAField, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    List<SNode> structureFields = SNodeOperations.getNodeDescendants(SNodeOperations.getParent(structureAsAField), MetaAdapterFactory.getConcept(0xe00ab26049b415aL, 0x83b6dc09f3615dc4L, 0x62cd8899af79708bL, "DataDictionary.structure.StructureAsAField"), false, new SAbstractConcept[]{});
    ...
    if (brojPonavljanja > 1) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(structureAsAField, "You cannot define two fields with the same name.", "r:b01331ca-60f7-41d0-9131-b144a112f96d(DataDictionary.typesystem)", "6672132039943226387", null, errorTarget);
      }
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return MetaAdapterFactory.getConcept(0xe00ab26049b415aL, 0x83b6dc09f3615dc4L, 0x62cd8899af79708bL, "DataDictionary.structure.StructureAsAField");
  }
