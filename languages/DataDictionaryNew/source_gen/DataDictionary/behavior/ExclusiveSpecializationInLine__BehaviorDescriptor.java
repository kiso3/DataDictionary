...
public final class ExclusiveSpecializationInLine__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xe00ab26049b415aL, 0x83b6dc09f3615dc4L, 0x5947026603af5eb4L, "DataDictionary.structure.ExclusiveSpecializationInLine");
  private static final BehaviorRegistry REGISTRY = ConceptRegistry.getInstance().getBehaviorRegistry();

  public static final SMethod<String> getterName_idanJAv04YS6 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("geeterName").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("anJAv04YS6").registry(REGISTRY).build();
  ...
  /*package*/ ExclusiveSpecializationInLine__BehaviorDescriptor() {
    super(REGISTRY);
  }
