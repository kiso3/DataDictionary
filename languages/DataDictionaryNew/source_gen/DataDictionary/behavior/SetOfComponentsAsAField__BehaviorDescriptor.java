...
public final class SetOfComponentsAsAField__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xe00ab26049b415aL, 0x83b6dc09f3615dc4L, 0x62cd8899af7681e1L, "DataDictionary.structure.SetOfComponentsAsAField");
  ...
  /*package*/ static String setterName_idanJAv051NZ(@NotNull SNode __thisNode__) {
    String name = SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, MetaAdapterFactory.getReferenceLink(0xe00ab26049b415aL, 0x83b6dc09f3615dc4L, 0x62cd8899af79708bL, 0x62cd8899af797090L, "strucutreRef")), MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"));
    return "set" + name.substring(0, 1).toUpperCase() + name.substring(1) + "List";
  }
  ...
  /*package*/ SetOfComponentsAsAField__BehaviorDescriptor() {
    super(REGISTRY);
  }
