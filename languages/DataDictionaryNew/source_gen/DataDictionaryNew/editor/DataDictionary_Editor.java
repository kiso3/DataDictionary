...
public class DataDictionary_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_r8s0uu_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_r8s0uu_a1a(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNodeList_r8s0uu_a1a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new DataDictionary_Editor.structuresListHandler_r8s0uu_a1a(node, "structures", editorContext);
    EditorCell_Collection editorCell = handler.createCells(editorContext, new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_structures");
    editorCell.setRole(handler.getElementRole());
    return editorCell;
  }
  private static class structuresListHandler_r8s0uu_a1a extends RefNodeListHandler {
    public structuresListHandler_r8s0uu_a1a(SNode ownerNode, String childRole, EditorContext context) {
